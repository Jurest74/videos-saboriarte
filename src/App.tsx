        ...
        <div className="max-w-4xl w-full mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-orange-100 overflow-hidden mb-12">
            <div className="relative group">
              ...
              {/* Play overlay button - only show when paused */}
              {!playing && (
                <button
                  onClick={handlePlay}
                  className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-all duration-500"
                >
